...
from function_full import generate_full_dataset, normalize_dataset, combo2pretty, gen2gens, global_timeseries_from_folder_full, adjust_global_data, global_local_corr, filtering_conditions, reshape_mask2PCA, perform_pca, gen_signals, random_split, sequential_split
...
local_vars = ['MSSHF','SH','t2m','TCC','tp','UW','VW']
global_vars = ['MSLP','Z500']
...
storing_folder = 'generated_datasets'
try:
    os.mkdir(f'{storing_folder}/{pretty}')
except:
    pass
